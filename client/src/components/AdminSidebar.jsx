// import { MdDashboard, MdArticle, MdAdd, MdLogout, MdClose, MdEmail, MdWork, MdBriefcase } from 'react-icons/md';
...
//     { id: 'hiring', label: 'Hiring Management', icon: MdBriefcase, description: 'Manage job positions', path: '/admin/hiring' }, // Add this
//   ];
...
export default function AdminSidebar({ isOpen, onToggleSidebar, onLogout }) {
  ...
  const menuItems = [
    ...
    { id: 'contacts', label: 'Contact Forms', icon: MdEmail, description: 'View submissions', path: '/admin/contacts' },
    { id: 'careers', label: 'Career Applications', icon: MdWork, description: 'Job applications', path: '/admin/careers' },
    { id: 'hiring', label: 'Hiring Management', icon: MdBusinessCenter, description: 'Manage job positions', path: '/admin/hiring' },
  ];
