...
export const seoConfig = {
  ...
  ourWork: {
    title: 'Our Work & Portfolio - Award-Winning Campaigns | Mindframe',
    description:
  ...
  testimonials: {
    ...
    keywords: 'client testimonials, success stories, client reviews, feedback, client satisfaction, case studies',
    path: '/testimonials',
    type: 'website',
  },
